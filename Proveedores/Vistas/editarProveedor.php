            ...
            <form action="../Controlador/ProveedorController.php?action=actualizar" method="post">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="number" name="id_usuario" id="id_usuario" value="<?php echo $proveedor->getIdUsuario(); ?>" class="w-full px-3 py-2 border border-gray-300 rounded-lg" required>
                    </div>
                    <div>
