                ...
                <form method="GET" class="grid grid-cols-1 md:grid-cols-5 gap-4">
                    ...
                    <div>
                        ...
                        <input type="date" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                               id="desde" name="desde" value="<?php echo $_GET['desde'] ?? ''; ?>">
                    </div>
                    <div>
                        <label for="hasta" class="block text-sm font-medium text-gray-700 mb-2">Hasta</label>
                        <input type="date" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                               id="hasta" name="hasta" value="<?php echo $_GET['hasta'] ?? ''; ?>">
                    </div>
                    <div>
...
<div id="modalDetalleHistorial" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full flex items-center justify-center z-50">
                ...
                <div class="bg-gray-50 rounded-lg p-4">
                    ...
                    <div class="space-y-3">
                        <div class="flex justify-between">
                            ...
                            <span class="text-gray-900"><?php echo htmlspecialchars($evento_detalle['titulo']); ?></span>
                        </div>
                        <div class="flex justify-between">
                            <span class="font-medium text-gray-600">Descripción:</span>
                            <span class="text-gray-900"><?php echo htmlspecialchars($evento_detalle['descripcion']) ?: 'Sin descripción'; ?></span>
                        </div>
                        <div class="flex justify-between">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="text-gray-900"><?php echo htmlspecialchars($evento_detalle['organizador']); ?></span>
                        </div>
                    </div>
                </div>
                <div class="bg-gray-50 rounded-lg p-4">
                    ...
                    <div class="space-y-3">
                        <div class="flex justify-between">
                            ...
                            <span class="text-gray-900"><?php echo date('d/m/Y', strtotime($evento_detalle['fecha_evento'])); ?></span>
                        </div>
                        <div class="flex justify-between">
                            <span class="font-medium text-gray-600">Horario:</span>
                            <span class="text-gray-900"><?php echo date('H:i', strtotime($evento_detalle['hora_inicio'])); ?> - <?php echo date('H:i', strtotime($evento_detalle['hora_fin'])); ?></span>
                        </div>
                        <div class="flex justify-between">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="text-gray-900"><?php echo htmlspecialchars($evento_detalle['tipo_recurso']) ?: 'Sin recurso'; ?></span>
                        </div>
                    </div>
                </div>
            </div>
