...
<head>
    ...
    <title><?php echo $titulo_pagina ?? 'Sistema de Eventos LP2'; ?></title>
        ...
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex justify-between items-center py-4">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-xl font-bold">Sistema LP2 Eventos</h1>
                        <?php if (isset($titulo_pagina) && $titulo_pagina !== 'Sistema de Eventos LP2'): ?>
                ...
                <div class="flex items-center space-x-6">
                    ...
                    <?php else: ?>
                        <div class="flex items-center space-x-2">
                            <a href="/Lp2_Eventos/Autenticación/Vista/login.php"
